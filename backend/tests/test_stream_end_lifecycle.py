...
def test_manual_loop_stream_end_has_report():
    ...
    assert '"report_json"' in source or "'report_json'" in source, "ManualAgentLoop stream_end 缺少 report_json 字段"

    # 验证 stream_end 包含 report_id
    assert '"report_id"' in source or "'report_id'" in source, "ManualAgentLoop stream_end 缺少 report_id 字段"
...
def test_legacy_stream_end_has_report():
    ...
    assert '"report_json"' in source or "'report_json'" in source, "legacy 路径 reasoning_end 缺少 report_json 字段"
