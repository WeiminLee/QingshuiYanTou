...
Migrated from DeerFlow: packages/harness/deerflow/agents/middlewares/loop_detection_middleware.py
...
class LoopDetectionMiddleware(AgentMiddleware[AgentState]):
    ...
    def _get_thread_id(self, runtime: Any) -> str:
        ...
        # Fallback for simple dict-based state
        if isinstance(runtime, dict):
            thread_id = runtime.get("thread_id") or runtime.get("configurable", {}).get("thread_id")
            if thread_id:
                return str(thread_id)
        return "default"
    ...
    def _pending_key(self, runtime: Any) -> tuple[str, str]:
    ...
    def _queue_pending_warning(self, runtime: Any, warning: str) -> None:
    ...
    def _track_and_check(self, state: AgentState, runtime: Any) -> tuple[str | None, bool]:
    ...
    def _apply(self, state: AgentState, runtime: Any) -> dict | None:
    ...
    def _clear_other_run_pending_warnings(self, runtime: Any) -> None:
    ...
    def _clear_current_run_pending_warnings(self, runtime: Any) -> None:
    ...
    def _drain_pending_warnings(self, runtime: Any) -> list[str]:
