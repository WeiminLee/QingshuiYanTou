  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-section">
        ...
        <div v-if="!historyLoading && pastWeekHistory.length === 0" class="sidebar-empty-hint">暂无记录</div>
        <div v-else class="sidebar-list">
          <button
              ...
              <template v-if="item.role === 'assistant'">
                ...
                <template v-for="msg in messages" :key="msg.id">
                  <template v-if="msg.id === item.id">
                    ...
                    <!-- Suggestions -->
                    <div v-if="msg.suggestions && msg.suggestions.length > 0" class="t-chat-suggestions">
                      <button
          ...
          <div v-if="reportContent" class="report-section">
            ...
            <div class="compliance-stamp">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                <path d="M7 5v2.5M7 9.5v.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
              </svg>
...
// ─────────────────────────────────────────────────────────────────────────────
const {
  messages, threadId, taskId, isLoading, error, thinkingCollapsed, isConnected,
  sendMessage, stop, reset, startNewConversation
} = useChatSession()
...
.sidebar-loading { padding: 8px 4px; }
