...
export const useUiStore = defineStore('ui', () => {
  ...
  return {
    sidebarCollapsed, activePanel, selectedTarget, selectedInfo,
    toggleSidebar, setActivePanel, setSelectedSector, setSelectedStock, clearSelection,
    setSelectedInfo, clearInfoSelection,
    selectedCapital, setSelectedCapital,
  }
})
